...
BLECharacteristic * constructBLEServer(String name, BLEServerCallbacks* servercb,BLEDescriptor* descriptor, 
    BLECharacteristicCallbacks* normalcb, BLECharacteristicCallbacks* rssicb, BLECharacteristicCallbacks* configcb) {
    ...
    BLECharacteristic *pConfigCharacteristic = new BLECharacteristic(
        CHARA_CONFIG_UUID,
        BLECharacteristic::PROPERTY_READ |
        BLECharacteristic::PROPERTY_WRITE |
        BLECharacteristic::PROPERTY_NOTIFY |
