...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.93\linewidth]{images/experiment.png}
...
In total, during the non-contact survey, participants commented on more positive attributes than negative with 256 codes in favour of the system compared (NS1) to 168 attributes against system use (NS2).

Comment on the behaviour changing for each graph type, link to education goal and to codes for reasons. Also mention here that only 1 participant would not be comfortable using it in a workplace, with only 3 being unsure. Say that this high adoption rate coupled with learning shows education.
...
Overall users found the system to have more positive attributes than negative.

From an accuracy point of view the system definitely needs significant improvement.

Brief overview of met requirements.
