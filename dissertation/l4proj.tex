...
%==============================================================================
%% METADATA
\title{Keep Your Distance! Wearable Bluetooth Proximity Sensors}
...
\begin{abstract}
    ...
    potentially infections situation. This project investigated using bluetooth enabled 
    microcontrollers to provide active feedback to reduce risk of infection in the first instance.
    It also aims to provide data visualisations to allow identification of risk of infection over 
    time. This uses, ESP32 microcontrollers, bluetooth recieved signal strength, and mobile 
...
\def\consentdate {15 October 2020} % the date you agree
%
\educationalconsent
